...
$pyjs['loaded_modules']['pyjamas.ui.MouseListener'] = function (__mod_name__) {
	...
	$m['fireMouseEvent'] = function(listeners, sender, event) {
		var $iter5_nextval,$and3,$bool10,$bool11,$iter3_array,$iter5_array,$iter1_iter,$iter5_iter,to_element,$iter4_type,$iter5_type,$eq10,$iter2_type,$iter4_iter,$iter4_array,$iter5_idx,$iter3_idx,$iter2_iter,$iter3_nextval,$iter1_array,$and1,etype,$iter3_iter,$eq8,$eq9,$iter1_nextval,$eq2,$eq3,$and2,$eq1,$eq6,$eq7,$eq4,$eq5,$bool2,$bool3,$iter2_idx,$bool1,$bool6,$bool7,$bool4,$iter3_type,$bool8,$bool9,$iter1_type,listener,$iter2_nextval,$iter4_nextval,$and4,$iter4_idx,$iter1_idx,y,x,$bool5,$iter2_array;
		x = ($m['DOM']['eventGetClientX'](event))-($m['DOM']['getAbsoluteLeft'](sender['getElement']()));
		y = ($m['DOM']['eventGetClientY'](event))-($m['DOM']['getAbsoluteTop'](sender['getElement']()));
	...
	$m['MouseHandler'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(preventDefault) {
			...
			self['sinkEvents']($m['Event']['MOUSEEVENTS']);
			return null;
		}
	, 1, [null,null,['self'],['preventDefault', false]]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $attr3,$bool12,$bool13,$attr5,$attr4,etype,$attr6;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool12=$m['MOUSE_EVENTS']['__contains__'](etype)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
					...
					(typeof $bool12=='object'?
						(typeof $bool12['__nonzero__']=='function'?
							...
							(typeof $bool12['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool13=self['_mousePreventDefault']) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
				...
				return $m['fireMouseEvent'](self['_mouseListeners'], self, event);
			}
			return false;
		}
	...
	$m['MouseWheelHandler'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(preventDefault) {
			...
			self['sinkEvents']($m['Event']['ONMOUSEWHEEL']);
			return null;
		}
	, 1, [null,null,['self'],['preventDefault', false]]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $attr9,$iter6_idx,$iter6_type,$bool14,$bool15,$attr10,listener,$iter6_array,$iter6_iter,velocity,etype,$eq11,$eq12,$iter6_nextval;
			etype = $m['DOM']['eventGetType'](event);
					...
					(typeof $bool14=='object'?
						(typeof $bool14['__nonzero__']=='function'?
							...
							(typeof $bool14['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool15=self['_mouseWheelPreventDefault']) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
						false :
