...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	var $attr105,$bool1,$attr2,$attr1,$bool67,$bool66,$attr106;
	...
	$m['init'] = function() {
		...
		mousewheel = (typeof ($5=(typeof ($3=$m['Event']['eventbits'])['__array'] != 'undefined'?
			((typeof $3['__array'][$4=(typeof ($1=$m['Event']['eventmap'])['__array'] != 'undefined'?
			((typeof $1['__array'][$2='mousewheel']) != 'undefined'?$1['__array'][$2]:
				$1['__getitem__']($2)):
				$1['__getitem__']('mousewheel'))]) != 'undefined'?$3['__array'][$4]:
				$3['__getitem__']($4)):
				$3['__getitem__']((typeof ($1=$m['Event']['eventmap'])['__array'] != 'undefined'?
			((typeof $1['__array'][$2='mousewheel']) != 'undefined'?$1['__array'][$2]:
				$1['__getitem__']($2)):
	...
	$m['getLastChild'] = function(elem) {
		var $and9,$and12,$bool34,$attr44,$attr41,$bool32,$bool33,$and10,$and11,$attr42,$attr43,$attr40,child,$attr39,$eq15,$eq16;
				...
				(typeof $bool33['__nonzero__']=='function'?
					...
					(typeof $bool33['__len__']=='function'?
						($bool33['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq15=child['nodeType'])===($eq16=1)&&$eq15===null?true:
	...
	$m['getPrevSibling'] = function(elem) {
		var $eq18,$and13,$attr50,$attr47,$attr46,sib,$attr45,$bool37,$and14,$bool38,$attr49,$attr48,$eq17;
				...
				(typeof $bool37['__nonzero__']=='function'?
					...
					(typeof $bool37['__len__']=='function'?
						($bool37['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq17=sib['nodeType'])===($eq18=1)&&$eq17===null?true:
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $attr59,$attr58,$bool40,$attr60,$attr55,$attr61,$attr57,$attr56,$attr62,$bool39;
			if ((($bool40=!(($bool39=self['child']) === null || $bool39 === false || $bool39 === 0 || $bool39 === '' ?
				false :
	...
	, 1, [null,null,['self'],['elem'],['all_nodes', false]]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var nextSibling,firstChild,$cmp2,$attr82,$attr83,$attr80,$attr81,$attr68,$attr69,$attr84,$attr85,$attr67,$bool47,$bool46,$bool45,$bool44,$bool43,$bool42,$bool48,$attr86,$attr87,$cmp1,$attr79,$attr78,$attr77,$attr76,$attr75,$attr74,$attr73,$attr72,$attr71,$attr70,$len1,$attr88;
			if ((($bool43=!(($bool42=self['child']) === null || $bool42 === false || $bool42 === 0 || $bool42 === '' ?
				false :
			...
			self['lastChild'] = self['child'];
			if ((($bool44=self['all_nodes']) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
					false :
			...
			else if ((($bool48=((($cmp1=(($len1=self['stack']) === null?0:
	...
	$m['isOrHasChild'] = function(parent, child) {
		var $eq20,$attr94,$attr91,$bool51,$attr92,$attr93,$bool53,$bool49,$eq19,$bool52,$bool50;
		while ((($bool49=child) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
			...
			if ((($bool53=!(($eq19=child['nodeType'])===($eq20=1)&&$eq19===null?true:
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$bool56,$iter1_iter,$iter1_array,$iter1_type;
		res = '';
		$iter1_iter = name;
...
element['innerHTML'] = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$attr99,$iter2_idx,val,$attr100,$bool57,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool57=$p['hasattr'](element['style'], 'setProperty')) === null || $bool57 === false || $bool57 === 0 || $bool57 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$iter3_type,dispEvnt,$iter5_array,$9,$bool58,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$attr104,$attr102,$iter3_iter,$attr101,$attr103,$iter5_idx,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$13,$iter4_nextval,$iter4_idx,$iter4_array;
					...
					(typeof $bool58=='object'?
						(typeof $bool58['__nonzero__']=='function'?
							...
							(typeof $bool58['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$iter4_iter = (typeof ($11=(typeof ($9=$m['Event']['eventbits'])['__array'] != 'undefined'?
...
element['on'+event_name] = dispEvnt
				...
				$iter5_iter = (typeof ($15=(typeof ($13=$m['Event']['eventbits'])['__array'] != 'undefined'?
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool61,$cmp4,$17,$cmp3,$bool60,$18,$bool59,ret,$len2,$len3,preview;
		ret = true;
		if ((($bool59=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?0:
			...
			preview = (typeof ($17=$m['sEventPreviewStack'])['__array'] != 'undefined'?
				((typeof $17['__array'][$18=((($len3=$m['sEventPreviewStack']) === null?0:
				(typeof $len3['__array'] != 'undefined' ? $len3['__array']['length']:
					(typeof $len3['__len__'] == 'function'?$len3['__len__']():
						(typeof $len3['length'] != 'undefined'?$len3['length']:
							$p['len']($len3))))))-(1)]) != 'undefined'?$17['__array'][$18]:
					$17['__getitem__']($18)):
					$17['__getitem__'](((($len3=$m['sEventPreviewStack']) === null?0:
				(typeof $len3['__array'] != 'undefined' ? $len3['__array']['length']:
					(typeof $len3['__len__'] == 'function'?$len3['__len__']():
						(typeof $len3['length'] != 'undefined'?$len3['length']:
							$p['len']($len3))))))-(1)));
	...
	$m['insertListItem'] = function(select, item, value, index) {
		...
		if ((($bool65=(($eq25=index)===($eq26=-(1))&&$eq25===null?true:
	...
	if ((($bool67=!(($bool66=$m['pyjd']['is_desktop']) === null || $bool66 === false || $bool66 === 0 || $bool66 === '' ?
		false :
