...
$pyjs['loaded_modules']['pyjamas.Window'] = function (__mod_name__) {
	...
	$m['enableScrolling'] = function(enable) {
		...
		$doc['body']['style']['overflow'] = ((($bool2=$or1=((($bool1=$and1=enable) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
			false :
			(typeof $bool1=='object'?
	...
	$m['getScrollLeft'] = function() {
		var $attr9,$attr10;
		return $m['getDocumentRoot']()['scrollLeft'];
		return null;
	};
	...
	$m['getScrollTop'] = function() {
		var $attr11,$attr12;
		return $m['getDocumentRoot']()['scrollTop'];
		return null;
	};
	...
	$m['getDocumentRoot'] = function() {
		...
		if ((($bool3=(($eq1=$doc['compatMode'])===($eq2='CSS1Compat')&&$eq1===null?true:
				...
				(typeof $bool5=='object'?
					(typeof $bool5['__nonzero__']=='function'?
						...
						(typeof $bool5['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			$m['location'] = $m['Location']['Location']($wnd['location']);
		}
		return $m['location'];
	};
