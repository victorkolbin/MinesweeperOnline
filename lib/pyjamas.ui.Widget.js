...
$pyjs['loaded_modules']['pyjamas.ui.Widget'] = function (__mod_name__) {
					...
					(typeof $bool1=='object'?
						(typeof $bool1['__nonzero__']=='function'?
							...
							(typeof $bool1['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				self['sinkEvents']($m['Event']['ONCONTEXTMENU']);
			}
			else {
				self['unsinkEvents']($m['Event']['ONCONTEXTMENU']);
			}
			return null;
		}
	, 1, [null,null,['self'],['menu']]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var type,$bool10,$bool11,$eq1,$eq2,$bool2,$bool3,$bool12,$bool6,$bool7,$bool4,$bool5,$bool8,$bool9,$attr11,$attr12;
			...
			if ((($bool11=(self['contextMenu'] === null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					false :
	...
	, 1, [null,null,['self'],['layoutData']]);
		...
		$method = $pyjs__bind_method2('setParent', function(parent) {
			...
			var $bool18,$bool19,oldparent,$and1,$bool16,$bool17,$attr18,$attr15,$attr14,$attr17,$attr16,$and2,$attr13;
						...
						(typeof $bool17['__nonzero__']=='function'?
							...
							(typeof $bool17['__len__']=='function'?
								($bool17['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?oldparent['attached']:$and1)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
						false :
			...
			else if ((($bool19=parent['attached']) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
	...
	, 1, [null,null,['self'],['parent']]);
		...
		$method = $pyjs__bind_method2('removeFromParent', function() {
			...
			var $attr20,$attr19,$bool20;
			if ((($bool20=$p['hasattr'](self['parent'], 'remove')) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
					false :
