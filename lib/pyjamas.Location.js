...
$pyjs['loaded_modules']['pyjamas.Location'] = function (__mod_name__) {
	...
	$m['makeUrlStringFromDict'] = function(d) {
		var pairs,$iter2_nextval,$iter2_type,$iter2_iter,k,$iter2_idx,v,$iter2_array;
		pairs = $p['list']([]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getHashDict', function() {
			...
			if ((($bool4=((($bool3=$or1=!(($bool2=self['hashDict']) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
				false :
				(typeof $bool2=='object'?
					...
					(typeof $bool3['__nonzero__']=='function'?
						...
						(typeof $bool3['__len__']=='function'?
							($bool3['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or1:!(($eq1=self['hashDictHash'])===($eq2=self['getHash']())&&$eq1===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearch', function() {
			...
			var $or4,$or3,$attr23,$attr24,$bool7;
			return ((($bool7=$or3=self['location']['search']) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
				false :
				(typeof $bool7=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearchDict', function() {
			...
			var search,$attr25,$attr26,$attr27,$attr28,$bool8;
			if ((($bool8=(self['searchDict'] === null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
