...
r = Math['round'](n*x)/n;
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('_format_complex', function(w_complex) {
			...
			var re_grouped_digits,add_parens,im_have_dec,tp,re_num,im_n_remainder,re_remainder_ptr,skip_re,im_spec,$attr373,$attr375,$attr374,$attr377,$attr376,$attr379,$attr378,$eq330,$mod7,$mod8,out,$bool493,$bool492,$bool491,$bool497,$bool496,$bool495,$bool494,$bool499,$bool498,re_spec,tmp_align,$eq329,$eq328,$eq312,$eq321,$eq320,$eq323,$eq322,$eq325,$eq324,$eq327,$eq326,$148,$145,$144,$147,$146,$141,$140,$143,$142,re_n_remainder,$and59,tmp_fill_char,im_num,tmp_width,$eq318,$attr418,$attr410,$attr411,$attr412,$attr413,$attr414,$attr415,$attr416,$attr417,$138,$139,default_precision,$137,$attr388,$attr389,$attr384,$attr385,$attr386,$attr387,$attr380,$attr381,$attr382,$attr383,msg,re_sign,$attr408,$attr403,$attr402,$attr401,$attr400,$attr407,$attr406,$attr405,$attr404,n_im_digits,$attr399,$attr398,$attr397,$attr396,$attr395,$attr394,$attr393,$attr392,$attr391,$attr390,$eq314,$eq315,$eq316,$eq317,$eq311,$assign3,$eq313,to_real_number,$eq319,to_imag_number,$attr409,re_have_dec,$and60,fill,im_grouped_digits,n_re_digits,im_remainder_ptr,im_sign,$bool501,$bool500,$bool503,$bool502,$bool505,$bool504,$bool507,$bool506,$bool508;
			tp = self['_type'];
			self['_get_locale'](tp);
			default_precision = 6;
