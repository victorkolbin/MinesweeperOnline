...
$pyjs['loaded_modules']['sys'] = function (__mod_name__) {
	...
	$m['exc_info'] = function() {
		var le,start,tb,$and2,cls,$attr9,$attr8,$attr1,$and1,$attr3,$attr2,$attr5,$attr4,$attr7,$attr6,$bool2,$bool3,$bool1,$bool6,$bool7,$bool4,$bool5,$attr10,$cmp1,$cmp2;
		...
		if ((($bool4=!(($bool3=$p['hasattr'](le['error'], '__class__')) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
			false :
			(typeof $bool3=='object'?
		...
		return $p['tuple']([cls, le['error'], tb]);
	};
...
$m['save_exception_stack'] = function (start) {
	...
	$m['trackstacklist'] = function(stack, limit) {
		...
		var $bool13,$bool10,$bool11,$bool12,$and3,$and4,$bool14,stackstrings,$attr16,$attr15,msg,$attr14,$bool8,$bool9,$attr11,$attr13,$attr12;
