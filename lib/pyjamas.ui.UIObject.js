...
$pyjs['loaded_modules']['pyjamas.ui.UIObject'] = function (__mod_name__) {
	...
	$m['findStyleName'] = function(element, style) {
		var lastPos,$eq10,$and1,$and2,$or4,$eq8,$eq9,$or1,$or3,$or2,$eq2,$eq3,oldStyle,$eq1,$eq6,$eq7,$eq4,$eq5,$bool2,$bool3,$bool1,$bool6,$bool7,$bool4,$bool5,$cmp1,$4,$2,$3,$1,last,idx,$cmp2,$len2,$len1;
			...
			(typeof $len1['__array'] != 'undefined' ? $len1['__array']['length']:
				(typeof $len1['__len__'] == 'function'?$len1['__len__']():
					(typeof $len1['length'] != 'undefined'?$len1['length']:
						$p['len']($len1)))));
		while ((($bool2=!(($eq1=idx)===($eq2=-(1))&&$eq1===null?true:
			...
			if ((($bool4=((($bool3=$or1=(($eq3=idx)===($eq4=0)&&$eq3===null?true:
				...
				((typeof $1['__array'][$2=(idx)-(1)]) != 'undefined'?$1['__array'][$2]:
					$1['__getitem__']($2)):
					$1['__getitem__']((idx)-(1))))===($eq6=' ')&&$eq5===null?true:
	...
	$m['setStyleName'] = function(element, style, add) {
		var $bool12,$eq13,$eq15,idx,$bool10,$bool11,oldStyle,end,begin,$len3,$eq11,$bool8,$bool9,$eq14,$eq12,$eq16;
		oldStyle = $m['DOM']['getAttribute'](element, 'className');
				...
				(typeof $bool9=='object'?
					(typeof $bool9['__nonzero__']=='function'?
						...
						(typeof $bool9['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool10=(($eq11=idx)===($eq12=-(1))&&$eq11===null?true:
					...
					(typeof $bool10=='object'?
						(typeof $bool10['__nonzero__']=='function'?
							...
							(typeof $bool10['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$m['DOM']['setAttribute'](element, 'className', ((oldStyle)+(' '))+(style));
			}
			return null;
		}
		if ((($bool11=(($eq13=idx)===($eq14=-(1))&&$eq13===null?true:
		...
		if ((($bool12=(($eq15=idx)===($eq16=0)&&$eq15===null?true:
			...
			begin = $p['__getslice'](oldStyle, 0, (idx)-(1));
		}
		end = $p['__getslice'](oldStyle, (idx)+((($len3=style) === null?0:
			(typeof $len3['__array'] != 'undefined' ? $len3['__array']['length']:
				(typeof $len3['__len__'] == 'function'?$len3['__len__']():
					(typeof $len3['length'] != 'undefined'?$len3['length']:
						$p['len']($len3)))))), null);
		$m['DOM']['setAttribute'](element, 'className', (begin)+(end));
		return null;
	};
    ...
    var self = this['prototype'];
			var $attr1,$attr2;
			return ($m['Applier']['_getProps']())+(self['_props']);
		}
	, 2, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getOffsetHeight', function() {
			...
			var $attr5,$attr6;
			return $m['DOM']['getIntAttribute'](self['element'], 'offsetHeight');
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getOffsetWidth', function() {
			...
			var $attr8,$attr7;
			return $m['DOM']['getIntAttribute'](self['element'], 'offsetWidth');
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getStyleName', function() {
			...
			var $attr9,$attr10;
			return $m['DOM']['getAttribute'](self['element'], 'className');
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['attribute']]);
		...
		$method = $pyjs__bind_method2('getTitle', function() {
			...
			var $attr11,$attr12;
			return $m['DOM']['getAttribute'](self['element'], 'title');
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['element']]);
		...
		$method = $pyjs__bind_method2('setHeight', function(height) {
			...
			$m['DOM']['setStyleAttribute'](self['element'], 'height', $p['str'](height));
			return null;
		}
	, 1, [null,null,['self'],['height']]);
		...
		$method = $pyjs__bind_method2('getHeight', function() {
			...
			var $attr15,$attr16;
			return $m['DOM']['getStyleAttribute'](self['element'], 'height');
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['styleSuffix']]);
		...
		$method = $pyjs__bind_method2('setStyleName', function(element, style, add) {
			...
			style = element;
			$m['DOM']['setAttribute'](self['element'], 'className', style);
			return null;
		}
	...
	, 1, [null,null,['self'],['attribute'],['value', null]]);
		...
		$method = $pyjs__bind_method2('setTitle', function(title) {
			...
			var $attr23,$attr24;
			$m['DOM']['setAttribute'](self['element'], 'title', title);
			return null;
		}
	, 1, [null,null,['self'],['title']]);
		...
		$method = $pyjs__bind_method2('setWidth', function(width) {
			...
			$m['DOM']['setStyleAttribute'](self['element'], 'width', $p['str'](width));
			return null;
		}
	, 1, [null,null,['self'],['width']]);
		...
		$method = $pyjs__bind_method2('getWidth', function() {
			...
			var $attr28,$attr27;
			return $m['DOM']['getStyleAttribute'](self['element'], 'width');
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('sinkEvents', function(eventBitsToAdd) {
			...
			var $attr29,$attr30,$bool21;
			if ((($bool21=self['element']) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
					false :
	...
	, 1, [null,null,['self'],['eventBitsToAdd']]);
		...
		$method = $pyjs__bind_method2('setzIndex', function(index) {
			...
			var $attr31,$attr32;
			$m['DOM']['setIntStyleAttribute'](self['element'], 'zIndex', index);
			return null;
		}
	...
	, 1, [null,null,['self'],['element', null]]);
		...
		$method = $pyjs__bind_method2('getVisible', function(element) {
			...
			if (typeof element == 'undefined') element=arguments['callee']['__args__'][3][1];
			var $eq18,$attr35,$attr34,$attr33,$pyjs_try_err,$attr36,$bool23,$bool22,$eq17;
			...
			try {
				return !(($eq17=element['style']['display'])===($eq18='none')&&$eq17===null?true:
	...
	, 1, [null,null,['self'],['element', null]]);
		...
		$method = $pyjs__bind_method2('setVisible', function(element, visible) {
			...
			var $bool24,$bool25,$attr37,$attr38;
