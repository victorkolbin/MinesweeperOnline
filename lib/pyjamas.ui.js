...
$pyjs['loaded_modules']['pyjamas.ui'] = function (__mod_name__) {
	...
	, 1, [null,['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('applyValues', function() {
			...
			var $iter3_idx,args,$attr1,$iter3_type,$attr2,prop,$bool2,$bool3,$bool1,$iter3_iter,$iter3_array,$4,$3,$iter3_nextval,fn;
						...
						(typeof $bool2=='object'?
							(typeof $bool2['__nonzero__']=='function'?
								...
								(typeof $bool2['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					throw ($p['Exception']($p['sprintf']('setter function for %s does not exist in %s', $p['tuple']([prop, self['__class__']['__name__']]))));
				}
