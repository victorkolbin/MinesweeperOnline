...
$pyjs['loaded_modules']['pyjamas.Factory'] = function (__mod_name__) {
	...
	$m['createWidgetOnElement'] = function(element) {
		var txtargs,lbr,$8,$9,$iter1_iter,$eq9,$and1,arg,$eq10,$or1,$iter1_array,kwargs,klsname,findeq,$eq8,$eq1,$iter1_nextval,$or2,$eq2,$eq3,$and2,args,$eq6,$eq7,$eq4,$eq5,$bool2,$bool3,$and3,fc,$bool6,$bool4,$bool5,$6,$7,$4,$5,$3,$10,$iter1_type,k,$and4,$iter1_idx,v;
		fc = $m['DOM']['getAttribute'](element, 'id');
		lbr = fc['find']('(');
		klsname = $p['__getslice'](fc, 0, lbr);
		txtargs = $p['__getslice'](fc, (lbr)+(1), -(1));
		args = $p['list']([]);
		kwargs = $p['dict']([]);
		...
		while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
			arg = $iter1_nextval;
			findeq = arg['find']('=');
			if ((($bool2=(($eq1=findeq)===($eq2=-(1))&&$eq1===null?true:
				...
				v = $p['__getslice'](arg, (findeq)+(1), null);
				if ((($bool6=((($bool4=$or1=((($bool3=$and1=(($eq3=(typeof ($3=v)['__array'] != 'undefined'?
					...
					((typeof $5['__array'][$6=-(1)]) != 'undefined'?$5['__array'][$6]:
						$5['__getitem__']($6)):
						$5['__getitem__'](-(1))))===($eq6="'")&&$eq5===null?true:
					...
					((typeof $9['__array'][$10=-(1)]) != 'undefined'?$9['__array'][$10]:
						$9['__getitem__']($10)):
						$9['__getitem__'](-(1))))===($eq10='"')&&$eq9===null?true:
