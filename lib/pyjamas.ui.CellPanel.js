...
$pyjs['loaded_modules']['pyjamas.ui.CellPanel'] = function (__mod_name__) {
	...
	$m['CellPanel'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			kwargs['__setitem__']('HorizontalAlignment', kwargs['get']('HorizontalAlignment', $m['HasHorizontalAlignment']['ALIGN_LEFT']));
			kwargs['__setitem__']('VerticalAlignment', kwargs['get']('VerticalAlignment', $m['HasVerticalAlignment']['ALIGN_TOP']));
			...
			$m['DOM']['appendChild'](self['table'], self['body']);
    ...
    var self = this['prototype'];
			var $attr11,$attr12;
			return ($m['ComplexPanel']['_getProps']())+(self['_props']);
		}
	, 2, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getBorderWidth', function() {
			...
			var $attr17,$attr18;
			return $m['DOM']['getAttribute'](self['table'], 'border');
		}
	, 1, [null,null,['self']]);
					...
					(typeof $bool7=='object'?
						(typeof $bool7['__nonzero__']=='function'?
							...
							(typeof $bool7['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$m['DOM']['removeAttribute'](self['table'], 'border');
			}
			else {
				$m['DOM']['setAttribute'](self['table'], 'border', $p['sprintf']('%d', width));
			}
			return null;
		}
					...
					(typeof $bool14=='object'?
						(typeof $bool14['__nonzero__']=='function'?
							...
							(typeof $bool14['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$m['DOM']['removeAttribute'](self['table'], 'cellSpacing');
			}
			else {
				$m['DOM']['setAttribute'](self['table'], 'cellSpacing', $p['str'](spacing));
			}
			return null;
		}
					...
					(typeof $bool15=='object'?
						(typeof $bool15['__nonzero__']=='function'?
							...
							(typeof $bool15['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$m['DOM']['removeAttribute'](self['table'], 'cellPadding');
			}
			else {
				$m['DOM']['setAttribute'](self['table'], 'cellPadding', $p['str'](padding));
			}
			return null;
		}
