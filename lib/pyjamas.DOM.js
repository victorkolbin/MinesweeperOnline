...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	var $bool1,$attr274,$bool131,$attr2,$attr1,$attr273,$bool130;
	...
	$m['eventGetKeyCode'] = function(evt) {
		var $or5,$or7,$or6,$bool32,$bool33,$attr23,$attr24,$attr25,$attr26;
		return ((($bool32=$or5=evt['which']) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
			false :
				...
				(typeof $bool32['__nonzero__']=='function'?
					...
					(typeof $bool32['__len__']=='function'?
						($bool32['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?$or5:((($bool33=$or6=evt['keyCode']) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
			false :
	...
	$m['eventGetToElement'] = function(evt) {
		var $attr40,$eq20,$attr41,$eq18,$eq19,$attr42,$bool34,$bool35,$attr39,type,$eq17;
	...
	$m['getAbsoluteLeft'] = function(elem) {
		var $attr59,$attr58,curr,$attr51,$attr50,$attr53,$attr52,$attr55,$attr57,$attr54,$attr60,$bool36,$bool37,$attr56,left,$attr49;
		left = 0;
		curr = elem;
		while ((($bool36=curr['offsetParent']) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
				false :
	...
	$m['getAbsoluteTop'] = function(elem) {
		var $attr70,$bool39,curr,$attr69,$attr64,$attr65,top,$attr67,$attr62,$attr61,$attr71,$attr68,$bool38,$attr63,$attr66,$attr72;
		top = 0;
		curr = elem;
		while ((($bool38=curr['offsetParent']) === null || $bool38 === false || $bool38 === 0 || $bool38 === '' ?
				false :
	...
	$m['getChild'] = function(elem, index) {
		var count,$bool45,$bool46,$attr78,$attr77,$attr76,$attr75,$attr74,$attr73,next,$eq21,$eq23,$eq22,$eq24,child,$bool47;
		count = 0;
		...
		while ((($bool45=child) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
			...
			if ((($bool46=(($eq21=child['nodeType'])===($eq22=1)&&$eq21===null?true:
	...
	$m['getChildCount'] = function(elem) {
		var count,$attr82,$attr80,$attr81,$attr84,$attr79,$attr83,$eq26,$bool49,$bool48,$eq25,child;
		count = 0;
		child = elem['firstChild'];
				...
				(typeof $bool48=='object'?
					(typeof $bool48['__nonzero__']=='function'?
						...
						(typeof $bool48['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool49=(($eq25=child['nodeType'])===($eq26=1)&&$eq25===null?true:
	...
	$m['getChildIndex'] = function(parent, toFind) {
		var count,$attr86,$bool51,$attr85,$bool52,$attr88,$attr89,$attr90,$eq30,$eq27,child,$eq29,$bool50,$eq28,$attr87;
		count = 0;
		...
		while ((($bool50=child) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
			...
			if ((($bool52=(($eq29=child['nodeType'])===($eq30=1)&&$eq29===null?true:
	...
	$m['getFirstChild'] = function(elem) {
		var $bool54,$attr94,$attr96,$attr91,$attr93,$attr92,$bool53,$and12,$and13,$and11,$eq31,$attr95,$and14,child,$eq32,$bool55;
				...
				(typeof $bool54['__nonzero__']=='function'?
					...
					(typeof $bool54['__len__']=='function'?
						($bool54['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq31=child['nodeType'])===($eq32=1)&&$eq31===null?true:
	...
	$m['getLastChild'] = function(elem) {
		var $attr101,$attr97,$bool57,$eq34,$bool58,child,$attr99,$bool56,$attr98,$eq33,$and16,$and17,$attr100,$and15,$attr102,$and18;
				...
				(typeof $bool57['__nonzero__']=='function'?
					...
					(typeof $bool57['__len__']=='function'?
						($bool57['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq33=child['nodeType'])===($eq34=1)&&$eq33===null?true:
	...
	$m['getInnerHTML'] = function(element) {
		var $bool60,$and20,$bool59,$attr106,$attr105,$attr104,$pyjs_try_err,$attr103,$and22,$and21,$and19;
		try {
	...
	$m['getInnerText'] = function(element) {
		var $bool61,$bool63,$bool62,$attr110,$attr111,text,$attr113,$eq35,$attr115,$attr114,$attr107,$attr112,$eq36,child,$attr116,$attr108,$attr109;
		text = '';
		...
		while ((($bool61=child) === null || $bool61 === false || $bool61 === 0 || $bool61 === '' ?
				...
				(typeof $bool61=='object'?
					(typeof $bool61['__nonzero__']=='function'?
						...
						(typeof $bool61['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool62=(($eq35=child['nodeType'])===($eq36=1)&&$eq35===null?true:
			...
			else if ((($bool63=child['nodeValue']) === null || $bool63 === false || $bool63 === 0 || $bool63 === '' ?
					false :
	...
	$m['getIntStyleAttribute'] = function(elem, attr) {
		var $attr118,$attr117;
		return $m['getIntAttribute'](elem['style'], attr);
	};
	...
	$m['getPrevSibling'] = function(elem) {
		var $attr119,$bool67,$bool66,$attr120,sib,$attr122,$attr123,$attr124,$eq37,$attr121,$and23,$eq38,$and24;
				...
				(typeof $bool66['__nonzero__']=='function'?
					...
					(typeof $bool66['__len__']=='function'?
						($bool66['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq37=sib['nodeType'])===($eq38=1)&&$eq37===null?true:
	...
	$m['getNextSibling'] = function(elem) {
		var $bool69,$bool68,$eq40,sib,$attr130,$attr125,$attr126,$attr127,$attr128,$attr129,$eq39,$and26,$and25;
				...
				(typeof $bool68['__nonzero__']=='function'?
					...
					(typeof $bool68['__len__']=='function'?
						($bool68['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq39=sib['nodeType'])===($eq40=1)&&$eq39===null?true:
	...
	$m['getParent'] = function(elem) {
		var parent,$eq42,$eq41,$bool70,$bool71,$attr133,$attr134;
	...
	$m['getStyleAttribute'] = function(elem, attr) {
		var $attr140,$bool72,$bool73,$pyjs_try_err,$attr137,$attr136,$attr135,$attr139,$attr138;
		try {
			if ((($bool72=$p['hasattr'](elem['style'], 'getPropertyValue')) === null || $bool72 === false || $bool72 === 0 || $bool72 === '' ?
					false :
			...
			else if ((($bool73=$p['hasattr'](elem['style'], 'getProperty')) === null || $bool73 === false || $bool73 === 0 || $bool73 === '' ?
					false :
			...
			if (($pyjs_try_err_name == $p['AttributeError']['__name__'])||$p['_isinstance']($pyjs_try_err,$p['AttributeError'])) {
				return $p['getattr'](elem['style'], attr, null);
	...
	$m['insertChild'] = function(parent, toAdd, index) {
		var count,$attr141,$attr146,$attr143,$eq43,$bool77,$bool74,$bool75,$eq46,$eq45,$eq44,$bool76,$attr144,child,$attr145,before,$attr142;
		count = 0;
		child = parent['firstChild'];
		before = null;
				...
				(typeof $bool74=='object'?
					(typeof $bool74['__nonzero__']=='function'?
						...
						(typeof $bool74['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool75=(($eq43=child['nodeType'])===($eq44=1)&&$eq43===null?true:
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $attr155,$attr154,$attr152,$attr151,$attr150,$bool78,$bool79,$attr149,$attr153,$attr156;
			if ((($bool79=!(($bool78=self['child']) === null || $bool78 === false || $bool78 === 0 || $bool78 === '' ?
				false :
	...
	, 1, [null,null,['self'],['elem'],['all_nodes', false]]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var nextSibling,firstChild,$cmp2,$bool83,$bool82,$bool81,$attr168,$attr169,$bool85,$bool84,$attr164,$attr165,$attr167,$attr161,$attr162,$attr163,$attr182,$attr180,$attr181,$bool87,$bool86,$cmp1,$attr179,$attr178,$attr177,$attr176,$attr175,$attr174,$attr173,$attr172,$attr171,$attr170,$len1,$attr166;
			if ((($bool82=!(($bool81=self['child']) === null || $bool81 === false || $bool81 === 0 || $bool81 === '' ?
				false :
			...
			self['lastChild'] = self['child'];
			if ((($bool83=self['all_nodes']) === null || $bool83 === false || $bool83 === 0 || $bool83 === '' ?
					false :
			...
			else if ((($bool87=((($cmp1=(($len1=self['stack']) === null?0:
	...
	$m['isOrHasChild'] = function(parent, child) {
		var $bool90,$bool91,$bool92,$attr185,$attr188,$attr186,$attr187,$bool89,$bool88,$eq47,$eq48;
		while ((($bool88=child) === null || $bool88 === false || $bool88 === 0 || $bool88 === '' ?
			...
			if ((($bool92=!(($eq47=child['nodeType'])===($eq48=1)&&$eq47===null?true:
	...
	$m['scrollIntoView'] = function(elem) {
		var $attr193,$attr195,$attr194,$attr197,$attr196,$attr199,$attr198,$eq54,$eq55,$eq56,$eq57,$eq50,$eq51,$eq52,$eq53,$eq58,cur,offsetLeft,$attr251,$and30,$and31,$and32,$and33,$bool95,$bool96,$bool97,$bool98,$bool99,$attr218,$attr219,$attr212,$attr213,$attr210,$attr211,$attr216,$attr217,$attr214,$attr215,$and29,$attr209,$attr208,offsetTop,$attr205,$attr204,$attr207,$attr206,$attr201,$attr200,$attr203,$attr202,$cmp10,$attr256,$attr254,$attr255,$attr252,$attr253,$attr250,height,top,width,$attr241,$attr240,$attr243,$attr242,$attr245,$attr244,$attr247,$attr246,$attr249,$attr248,$eq49,$attr234,$attr235,$attr236,$attr237,$attr230,$attr231,$attr232,$attr233,$attr238,$attr239,$attr227,$attr226,$attr225,$attr224,$attr223,$attr222,$attr221,$attr220,$or9,$or8,$attr229,$attr228,$bool105,$bool104,$bool107,$bool106,$bool101,$bool100,$bool103,$bool102,$bool108,$cmp5,$cmp4,$cmp7,$cmp6,$cmp3,$cmp9,$cmp8,left;
		left = elem['offsetLeft'];
		top = elem['offsetTop'];
		width = elem['offsetWidth'];
		height = elem['offsetHeight'];
		if ((($bool95=!(($eq49=elem['parentNode'])===($eq50=elem['offsetParent'])&&$eq49===null?true:
		...
		while ((($bool97=((($bool96=$and29=cur) === null || $bool96 === false || $bool96 === 0 || $bool96 === '' ?
				...
				(typeof $bool96['__nonzero__']=='function'?
					...
					(typeof $bool96['__len__']=='function'?
						($bool96['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?(($eq51=cur['nodeType'])===($eq52=1)&&$eq51===null?true:
			...
			if ((($bool101=((($bool98=$and31=$p['hasattr'](cur, 'style')) === null || $bool98 === false || $bool98 === 0 || $bool98 === '' ?
					...
					(typeof $bool98['__nonzero__']=='function'?
						...
						(typeof $bool98['__len__']=='function'?
							($bool98['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool99=$and32=$p['hasattr'](cur['style'], 'overflow')) === null || $bool99 === false || $bool99 === 0 || $bool99 === '' ?
				false :
					...
					(typeof $bool99['__nonzero__']=='function'?
						...
						(typeof $bool99['__len__']=='function'?
							($bool99['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool100=$or8=(($eq53=cur['style']['overflow'])===($eq54='auto')&&$eq53===null?true:
					...
					(typeof $bool100['__nonzero__']=='function'?
						...
						(typeof $bool100['__len__']=='function'?
							($bool100['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or8:(($eq55=cur['style']['overflow'])===($eq56='scroll')&&$eq55===null?true:
					...
					(typeof $bool101=='object'?
						(typeof $bool101['__nonzero__']=='function'?
							...
							(typeof $bool101['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool102=((($cmp3=left)===($cmp4=cur['scrollLeft'])?0:
				...
				if ((($bool103=((($cmp5=(left)+(width))===($cmp6=(cur['scrollLeft'])+(cur['clientWidth']))?0:
				...
				if ((($bool104=((($cmp7=top)===($cmp8=cur['scrollTop'])?0:
				...
				if ((($bool105=((($cmp9=(top)+(height))===($cmp10=(cur['scrollTop'])+(cur['clientHeight']))?0:
			...
			if ((($bool106=!(($eq57=cur['parentNode'])===($eq58=cur['offsetParent'])&&$eq57===null?true:
					...
					(typeof $bool106=='object'?
						(typeof $bool106['__nonzero__']=='function'?
							...
							(typeof $bool106['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool107=$p['hasattr'](cur['parentNode'], 'offsetLeft')) === null || $bool107 === false || $bool107 === 0 || $bool107 === '' ?
						false :
				...
				if ((($bool108=$p['hasattr'](cur['parentNode'], 'offsetTop')) === null || $bool108 === false || $bool108 === 0 || $bool108 === '' ?
						false :
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$iter1_iter,$iter1_array,$bool109,$iter1_type;
		res = '';
		$iter1_iter = name;
	...
	$m['setInnerText'] = function(elem, text) {
		var $attr258,$attr259,$attr260,$bool110,$bool111,$or11,$or10,$attr257;
		while ((($bool110=(elem['firstChild'] !== null)) === null || $bool110 === false || $bool110 === 0 || $bool110 === '' ?
				false :
	...
	$m['setIntStyleAttribute'] = function(elem, attr, value) {
		var mf,$attr262,$attr261,$bool112;
		mf = (typeof get_main_frame == "undefined"?$m['get_main_frame']:get_main_frame)();
		if ((($bool112=$p['hasattr'](elem['style'], 'setProperty')) === null || $bool112 === false || $bool112 === 0 || $bool112 === '' ?
				false :
	...
	$m['setStyleAttribute'] = function(element, name, value) {
		var $attr263,$attr264,$bool113;
		if ((($bool113=$p['hasattr'](element['style'], 'setProperty')) === null || $bool113 === false || $bool113 === 0 || $bool113 === '' ?
				false :
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$attr266,$attr265,$iter2_idx,val,$bool114,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool114=$p['hasattr'](element['style'], 'setProperty')) === null || $bool114 === false || $bool114 === 0 || $bool114 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $attr270,cb,$attr272,$iter3_type,$bool116,$bool117,$bool115,$bool118,$bool119,$4,$iter3_idx,$iter3_array,$iter3_nextval,$3,$iter3_iter,$attr271,$attr269,$attr268,event_name,$attr267,$cmp11,$cmp12,$6,bit,$5,$bool122,$bool121,$bool120,mf,aev,mask;
					...
					(typeof $bool122=='object'?
						(typeof $bool122['__nonzero__']=='function'?
							...
							(typeof $bool122['__len__']=='function'?
								...
								true ) ) :
						 true ) )) {
				$iter3_iter = (typeof ($5=(typeof ($3=$m['Event']['eventbits'])['__array'] != 'undefined'?
	...
	$m['insertListItem'] = function(select, item, value, index) {
		...
		if ((($bool129=(($eq65=index)===($eq66=-(1))&&$eq65===null?true:
	...
	if ((($bool131=!(($bool130=$m['pyjd']['is_desktop']) === null || $bool130 === false || $bool130 === 0 || $bool130 === '' ?
		false :
