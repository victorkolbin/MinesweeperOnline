...
$pyjs['loaded_modules']['genericpath'] = function (__mod_name__) {
	...
	$m['exists'] = function(path) {
		var $attr1,$attr3,$attr2,$attr4,$pyjs_try_err;
		try {
			$m['os']['stat'](path);
		} catch($pyjs_try_err) {
			var $pyjs_try_err_name = (typeof $pyjs_try_err['__name__'] == 'undefined' ? $pyjs_try_err['name'] : $pyjs_try_err['__name__'] );
			$pyjs['__last_exception__'] = {'error': $pyjs_try_err, 'module': $m};
			if (($pyjs_try_err_name == $m['os']['error']['__name__'])||$p['_isinstance']($pyjs_try_err,$m['os']['error'])) {
				return false;
	...
	$m['isfile'] = function(path) {
		var $attr9,$attr8,$attr5,$attr7,$attr6,$pyjs_try_err,st,$attr10;
		try {
			st = $m['os']['stat'](path);
		} catch($pyjs_try_err) {
			var $pyjs_try_err_name = (typeof $pyjs_try_err['__name__'] == 'undefined' ? $pyjs_try_err['name'] : $pyjs_try_err['__name__'] );
		...
		return $m['stat']['S_ISREG'](st['st_mode']);
	};
	...
	$m['isdir'] = function(s) {
		var st,$pyjs_try_err,$attr15,$attr14,$attr16,$attr11,$attr13,$attr12;
		try {
			st = $m['os']['stat'](s);
		} catch($pyjs_try_err) {
			var $pyjs_try_err_name = (typeof $pyjs_try_err['__name__'] == 'undefined' ? $pyjs_try_err['name'] : $pyjs_try_err['__name__'] );
		...
		return $m['stat']['S_ISDIR'](st['st_mode']);
	};
	...
	$m['getsize'] = function(filename) {
		var $attr17,$attr18;
		return $m['os']['stat'](filename)['st_size'];
	};
	...
	$m['getmtime'] = function(filename) {
		var $attr20,$attr19;
		return $m['os']['stat'](filename)['st_mtime'];
	};
	...
	$m['getatime'] = function(filename) {
		var $attr21,$attr22;
		return $m['os']['stat'](filename)['st_atime'];
	};
	...
	$m['getctime'] = function(filename) {
		var $attr23,$attr24;
		return $m['os']['stat'](filename)['st_ctime'];
	};
	...
	$m['_splitext'] = function(p, sep, altsep, extsep) {
		var sepIndex,$cmp4,$cmp2,$cmp1,filenameIndex,$cmp3,$eq3,$4,$eq4,altsepIndex,$bool6,$bool7,$bool4,dotIndex,$bool5,$3;
