...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	var $bool61,$attr102,$bool1,$attr2,$attr1,$bool60,$attr101;
	...
	$m['getLastChild'] = function(elem) {
		var $and9,$bool35,$bool34,$attr44,$attr41,$and12,$bool33,$and10,$and11,$attr42,$attr43,$attr40,child,$attr39,$eq18,$eq17;
	...
	$m['getPrevSibling'] = function(elem) {
		var $eq20,$and13,$attr50,$attr47,$attr46,sib,$attr45,$and14,$bool38,$bool39,$eq19,$attr48,$attr49;
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $attr59,$attr58,$bool41,$bool40,$attr60,$attr55,$attr61,$attr57,$attr56,$attr62;
	...
	, 1, [null,null,['self'],['elem'],['all_nodes', false]]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var nextSibling,firstChild,$cmp2,$attr82,$attr83,$attr80,$attr81,$attr68,$attr69,$attr84,$attr85,$attr67,$bool47,$bool46,$bool45,$bool44,$bool43,$bool49,$bool48,$attr86,$attr87,$cmp1,$attr79,$attr78,$attr77,$attr76,$attr75,$attr74,$attr73,$attr72,$attr71,$attr70,$len1,$attr88;
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$iter1_iter,$iter1_array,$bool50,$iter1_type;
		res = '';
		$iter1_iter = name;
...
element['innerHTML'] = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $attr95,$iter2_nextval,$iter2_type,attr,$iter2_iter,$attr96,$iter2_idx,val,$iter2_array,$bool51;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool51=$p['hasattr'](element['style'], 'setProperty')) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$bool52,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$attr100,$iter5_idx,event_name,$16,$iter3_array,bit,$14,$15,$attr97,$10,$11,$12,$13,$iter4_nextval,$attr99,$attr98,$iter4_idx,$iter3_type,$iter4_array;
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool54,$cmp4,$17,$cmp3,$bool53,$18,ret,$bool55,$len2,$len3,preview;
		ret = true;
	...
	$m['insertListItem'] = function(select, item, value, index) {
		...
		if ((($bool59=(($eq25=index)===($eq26=-(1))&&$eq25===null?true:
