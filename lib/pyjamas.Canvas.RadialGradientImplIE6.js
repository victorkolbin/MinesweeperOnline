...
$pyjs['loaded_modules']['pyjamas.Canvas.RadialGradientImplIE6'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['x0'],['y0'],['r0'],['x1'],['y1'],['r1']]);
		...
		$method = $pyjs__bind_method2('cloneGradient', function() {
			...
			var cStops,$iter1_iter,$attr20,$attr21,$attr22,$attr23,$attr24,$attr25,$attr26,$2,$iter1_array,$1,$attr9,$attr8,$iter1_nextval,$attr1,$attr3,$attr2,$attr5,$attr4,$attr7,$attr6,$attr19,$attr18,$attr15,$attr14,$attr17,$attr16,$attr11,$attr10,$attr13,$attr12,$iter1_type,i,$iter1_idx,$len1,newGrad;
			newGrad = $m['RadialGradientImplIE6'](self['startX'], self['startY'], self['startRad'], self['endX'], self['endY'], self['endRad']);
