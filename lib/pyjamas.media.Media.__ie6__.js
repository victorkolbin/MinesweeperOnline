...
$pyjs['loaded_modules']['pyjamas.media.Media'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getError', function() {
			...
			var $or1,$or2,$attr1,$attr2,$bool1;
			return ((($bool1=$or1=self['getElement']()['error']) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
				false :
				(typeof $bool1=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('isLoop', function() {
			...
			var $attr23,$attr24;
			return $p['bool'](self['getElement']()['loop']);
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['autobuffer']]);
		...
		$method = $pyjs__bind_method2('setAutoplay', function(autostart) {
			...
			var $attr33,$or4,$or3,$bool3,$and1,$bool2,$attr32,$attr31,$attr30,$attr34,$attr29,$and2;
			self['playparam'] = $m['DOM']['createElement']('PARAM');
			$m['DOM']['setAttribute'](self['playparam'], 'name', 'autostart');
			$m['DOM']['setBooleanAttribute'](self['playparam'], 'VALUE', ((($bool3=$or3=((($bool2=$and1=autostart) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
				false :
				(typeof $bool2=='object'?
					(typeof $bool2['__nonzero__']=='function'?
						...
						(typeof $bool2['__len__']=='function'?
							($bool2['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?'true':$and1)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
				false :
				(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['autostart']]);
		...
		$method = $pyjs__bind_method2('setLoop', function(autorewind) {
			...
			var $or5,$attr40,$or6,$and3,$and4,$attr37,$attr36,$attr35,$bool5,$attr39,$attr38,$bool4;
			self['loopparam'] = $m['DOM']['createElement']('PARAM');
			$m['DOM']['setAttribute'](self['loopparam'], 'name', 'autorewind');
			$m['DOM']['setBooleanAttribute'](self['loopparam'], 'VALUE', ((($bool5=$or5=((($bool4=$and3=autorewind) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
				false :
				(typeof $bool4=='object'?
					(typeof $bool4['__nonzero__']=='function'?
						...
						(typeof $bool4['__len__']=='function'?
							($bool4['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?'true':$and3)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
				false :
				(typeof $bool5=='object'?
	...
	, 1, [null,null,['self'],['autorewind']]);
		...
		$method = $pyjs__bind_method2('setControls', function(controls) {
			...
			var $or7,$and6,$and5,$or8,$attr46,$attr44,$attr45,$attr42,$attr43,$attr41,$bool6,$bool7;
			self['ctrlparam'] = $m['DOM']['createElement']('PARAM');
			$m['DOM']['setAttribute'](self['ctrlparam'], 'name', 'ShowControls');
			$m['DOM']['setBooleanAttribute'](self['ctrlparam'], 'VALUE', ((($bool7=$or7=((($bool6=$and5=controls) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
				false :
				(typeof $bool6=='object'?
					(typeof $bool6['__nonzero__']=='function'?
						...
						(typeof $bool6['__len__']=='function'?
							($bool6['__len__']()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?'true':$and5)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
				false :
				(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['handler'],['etype']]);
		...
		$method = $pyjs__bind_method2('sinkMediaEvents', function(eventBitsToAdd) {
			...
			var $bool8;
			if ((($bool8=self['isOrWasAttached']()) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['eventBitsToAdd']]);
		...
		$method = $pyjs__bind_method2('doAttachChildren', function() {
			...
			var $cmp1,$cmp2,$attr50,bitsToAdd,$bool9,$attr49;
			bitsToAdd = self['mediaEventsToSink'];
			self['mediaEventsToSink'] = -(1);
			if ((($bool9=((($cmp1=bitsToAdd)===($cmp2=0)?0:
	...
	, 1, [null,null,['self'],['handler']]);
		...
		$method = $pyjs__bind_method2('maybeInitMediaEvents', function() {
			...
			var $bool10,$bool11,mediaEventsInitialized;
			if ((($bool11=!(($bool10=(typeof mediaEventsInitialized == "undefined"?$m['mediaEventsInitialized']:mediaEventsInitialized)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
				false :
