...
$pyjs['loaded_modules']['pyjspath'] = function (__mod_name__) {
	...
	$m['join'] = function(a) {
		...
		var b,$iter1_nextval,$iter1_type,$bool3,$or2,$eq2,$eq1,$iter1_iter,$bool2,$bool1,$iter1_array,path,$or1,$iter1_idx;
		path = a;
		$iter1_iter = p;
	...
	$m['$$split'] = function(p) {
		var head,$eq3,i,$and1,$and2,$bool5,$eq4,tail,$bool4,$len1;
		i = (p['rfind']('/'))+(1);
				...
				(typeof $bool4['__nonzero__']=='function'?
					...
					(typeof $bool4['__len__']=='function'?
						($bool4['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq3=head)===($eq4=('/')*((($len1=head) === null?0:
			(typeof $len1['__array'] != 'undefined' ? $len1['__array']['length']:
				(typeof $len1['__len__'] == 'function'?$len1['__len__']():
					(typeof $len1['length'] != 'undefined'?$len1['length']:
						$p['len']($len1)))))))&&$eq3===null?true:
	...
	$m['dirname'] = function(p) {
		var head,i,$eq6,$and3,$and4,$eq5,$bool6,$bool7,$len2;
		i = (p['rfind']('/'))+(1);
				...
				(typeof $bool6['__nonzero__']=='function'?
					...
					(typeof $bool6['__len__']=='function'?
						($bool6['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq5=head)===($eq6=('/')*((($len2=head) === null?0:
			(typeof $len2['__array'] != 'undefined' ? $len2['__array']['length']:
				(typeof $len2['__len__'] == 'function'?$len2['__len__']():
					(typeof $len2['length'] != 'undefined'?$len2['length']:
						$p['len']($len2)))))))&&$eq5===null?true:
	...
	$m['samestat'] = function(s1, s2) {
		var $attr7,$attr8,$eq8,$eq9,$attr1,$attr2,$attr5,$attr4,$and5,$eq7,$and6,$eq10,$bool8,$attr6,$attr3;
		return ((($bool8=$and5=(($eq7=s1['st_ino'])===($eq8=s2['st_ino'])&&$eq7===null?true:
				...
				(typeof $bool8['__nonzero__']=='function'?
					...
					(typeof $bool8['__len__']=='function'?
						($bool8['__len__']()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?(($eq9=s1['st_dev'])===($eq10=s2['st_dev'])&&$eq9===null?true:
	...
	$m['normpath'] = function(path) {
		var $bool18,$bool19,$or4,$bool10,$bool11,$bool12,$bool13,$bool14,$bool15,$bool16,$bool17,initial_slashes,$eq11,$eq12,$eq13,$eq14,$eq15,$eq16,$or5,$iter2_iter,$bool24,$bool21,$bool20,slash,$bool22,new_comps,$and8,$and9,$or7,$or6,$iter2_type,$bool23,$or3,comp,$and7,$and12,comps,$iter2_idx,$and11,$bool9,$2,$1,$iter2_nextval,$and13,$and10,dot,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			if ((($bool21=((($bool18=$or3=!(($eq13=comp)===($eq14='..')&&$eq13===null?true:
				...
				((typeof $1['__array'][$2=-(1)]) != 'undefined'?$1['__array'][$2]:
					$1['__getitem__']($2)):
					$1['__getitem__'](-(1))))===($eq16='..')&&$eq15===null?true:
	...
	$m['supports_unicode_filenames'] = (($eq17=$m['sys']['platform'])===($eq18='darwin')&&$eq17===null?true:
