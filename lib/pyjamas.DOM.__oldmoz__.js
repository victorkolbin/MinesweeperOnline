...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	var $bool59,$attr102,$bool1,$attr2,$attr1,$bool60,$attr101;
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$bool49,$iter1_iter,$iter1_array,$iter1_type;
		res = '';
		$iter1_iter = name;
...
element['innerHTML'] = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $attr95,$iter2_nextval,$iter2_type,attr,$iter2_iter,$attr96,$iter2_idx,val,$bool50,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool50=$p['hasattr'](element['style'], 'setProperty')) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$bool51,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$attr100,$iter5_idx,event_name,$16,$iter3_array,bit,$14,$15,$attr97,$10,$11,$12,$13,$iter4_nextval,$attr99,$attr98,$iter4_idx,$iter4_array;
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool54,$cmp4,$17,$cmp3,$bool52,$bool53,$18,ret,$len2,$len3,preview;
		ret = true;
	...
	$m['insertListItem'] = function(select, item, value, index) {
		...
		if ((($bool58=(($eq23=index)===($eq24=-(1))&&$eq23===null?true:
	...
	if ((($bool60=!(($bool59=$m['pyjd']['is_desktop']) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
		false :
